...
/*LPDAC Configure */
  ...
  .SensorBias = 1000,            /* Sets voltage between RE0 and SE0 */
...
AD5940Err AppAMPCtrl(int32_t AmpCtrl, void *pPara)
{
  switch (AmpCtrl)
  {
    case AMPCTRL_START:
    {
      ...
      wupt_cfg.SeqxWakeupTime[SEQID_0] = (uint32_t)(AppAMPCfg.WuptClkFreq*AppAMPCfg.AmpODR)-4;
...
static AD5940Err AppAMPSeqCfgGen(void)
{
  ...
  }else
  {
    lp_loop.LpAmpCfg.LpTiaRtia = AppAMPCfg.LptiaRtiaSel;
		...
		//here set the switch of low power TIA, the ce0 and re0 is connected the PA
    lp_loop.LpAmpCfg.LpTiaSW = LPTIASW(5)|LPTIASW(2)|LPTIASW(4)|LPTIASW(12)|LPTIASW(13); 
		//do not use re0, swicth10
    //lp_loop.LpAmpCfg.LpTiaSW = LPTIASW(5)|LPTIASW(2)|LPTIASW(10)|LPTIASW(12)|LPTIASW(13);
