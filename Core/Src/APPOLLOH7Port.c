...
#define AD5940_GP0INT_GPIO_CLK_ENABLE()    __HAL_RCC_GPIOF_CLK_ENABLE()
...
#define AD5940_RST_PIN                     GPIO_PIN_0   
#define AD5940_RST_GPIO_PORT               GPIOB

#define AD5940_GP0INT_PIN                  GPIO_PIN_6   
#define AD5940_GP0INT_GPIO_PORT            GPIOF
#define AD5940_GP0INT_IRQn                 EXTI9_5_IRQn
...
uint32_t AD5940_MCUResourceInit(void *pCfg)
{
  ...
  SpiHandle.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_64; //SPI clock should be < AD5940_SystemClock
