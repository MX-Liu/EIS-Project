 ...
 *****************************************************************************
 @file:    voltage.h
 @author:  Mengxi Liu
 @brief:   2-wire voltage measurement header file.
*****************************************************************************/
#ifndef _VOLTAGESEQUENCES_H_
#define _VOLTAGESEQUENCES_H_
#include "ad5940.h"
#include <stdio.h>
#include "string.h"
#include "math.h"
...
/* Private variables for internal usage */
  ...
  BoolFlag APPInited;                       /* If the program run firstly, generated sequence commands */
...
#define VOLCTRL_START          0
#define VOLCTRL_STOPNOW        1
#define VOLCTRL_STOPSYNC       2
#define VOLCTRL_GETFREQ        3   /* Get Current frequency of returned data from ISR */
#define VOLCTRL_SHUTDOWN       4   /* Note: shutdown here means turn off everything and put AFE to hibernate mode. The word 'SHUT DOWN' is only used here. */
